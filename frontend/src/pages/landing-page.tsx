...
const LandingPage = () => {
  ...
  <>
   <AuroraBackground>
    <Navbar/>
    <section id="#Landingpage" className="relative h-full w-full flex flex-1">     
        ...
        <div>
          ...
          className="flex flex-col gap-y-4 text-center md:text-start">
             ...
             <Link to="/signup">
              <Button 
               variant="outline"
              className="font-palanquin sm:text-lg p-4 sm:px-20 sm:py-6 bg-background">Quick Demo</Button>
              </Link>

              <Link to="/signup">
              <Button 
              className="font-palanquin sm:text-lg p-4 sm:px-20 sm:py-6">Get Started</Button>
              </Link>
             </div>
            </motion.div>
            {/*"IMAGE COMPONENT"*/}
            ...
            variants={{
             ...
             className="relative h-80 w-80 xs:h-[450px] xs:w-[450px] sm:h-[500px] sm:w-[600px]">
              <img
                src={LandingImg}
                alt="landing"
                className="absolute w-full h-auto inset-0 object-cover overflow-hidden"
              />
            </motion.div>
          </div>
        </div>
